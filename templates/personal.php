    ...
    <main class="main">
      ...
      <article class="personal">
        <div class="personal__photo">
          <img src="../assets/images/individual_lesson.jpg" alt="personal trainer photo" class="personal__image" />
        </div>
        <ul class="personal__text">
          <li class="about-text__item">
            Очень эффективный и необычайно интересный способ научиться азам фехтования: работе с клинком, выбору
            правильной дистанции и другим фехтовальным аспектам один на один с профессиональным тренером.
          </li>
          <li class="about-text__item">
            Особенно полезны для начинающих спортсменов-любителей. Индивидуальный подход. Тренер составляет программу
            уроков с учетом индивидуальных особенностей и расписания спортсмена.
          </li>
        </ul>
      </article>
    </main>
